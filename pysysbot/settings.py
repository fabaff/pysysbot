...
# Copyright (c) 2009-2015 Fabian Affolter <fabian@affolter-engineering.ch>
#
...
def read_config(file, config_jabber={}):
    ...
    if not(os.path.exists(file)):
        ...
        if config_jabber['username'] == 'NOT_SET':
            print('Please edit your configuration file (%s) and set your JID', file)
            sys.exit(0)
        config_jabber['password'] = configparse.get('pysysbot', 'password')
        if config_jabber['password'] == 'NOT_SET':
            print('Please edit your configuration file (%s) and set your Jabber password', file)
            sys.exit(0)
